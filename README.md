...
<details>
<summary>🕹️ <strong>单人模式</strong>（index.html）<br>&nbsp;&nbsp;&nbsp;&nbsp;<sub>完整剧本 · 多模型AI · AI说书人 · 邪恶密聊 · 语音播报 · BGM歌单 · 语音输入 · Token追踪 · 自动保存…</sub></summary>
...
<details>
<summary>🏆 <strong>AI 对战评测系统</strong>（benchmark/）<br>&nbsp;&nbsp;&nbsp;&nbsp;<sub>全自动对战 · 公平配板轮转 · 排行榜 · 数据浏览器 · 推理链记录 · 断点续跑…</sub></summary>
...
<details>
<summary>😇 **善良阵营** — 镇民 13 个 + 外来者 4 个<sub>👇 打开折叠，查看角色详细介绍：洗衣妇 · 图书管理员 · 调查员 · 厨师 · 共情者 · 占卜师 · 送葬者 · 僧侣 · 守鸦人 · 贞洁者 · 猎手 · 士兵 · 镇长 · 管家 · 酒鬼 · 陌客 · 圣徒</sub></summary>
...
<details>
<summary>😈 **邪恶阵营** — 爪牙 4 个 + 恶魔 1 个<sub>👇 打开折叠，查看角色详细介绍：投毒者 · 间谍 · 红唇女郎 · 男爵 · 小恶魔</sub></summary>
