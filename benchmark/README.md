...
| 占卜师 | 每晚选两人查是否有恶魔 | 干扰项（红鲱鱼）始终显示为恶魔 |
...
3. **辩护**：被提名者有辩护机会
4. **投票**：从被提名者邻座开始轮流投票，得票超过存活玩家半数则处决
...
| 角色 | 触发条件 | 效果 |
|------|---------|------|
| **贞洁者** | 首次被镇民提名时 | 提名者被立即处决（每局限一次，需未醉酒/中毒） |
| **猎手** | 白天公开声明开枪（严格格式） | 若命中恶魔则恶魔死亡（每局限一次，需清醒且未中毒） |
| **圣徒** | 被处决 | 善良阵营立即失败 |
| **红唇女郎** | 恶魔死亡且存活玩家 >= 5 | 自动成为新的小恶魔，游戏继续 |
